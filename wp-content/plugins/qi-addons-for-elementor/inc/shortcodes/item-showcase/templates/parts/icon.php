...
if ( ! empty( $item['item_link']['url'] ) ) :
	?>
	<a itemprop="url" href="<?php echo esc_url( $item['item_link']['url'] ); ?>" <?php qi_addons_for_elementor_framework_inline_attrs( qi_addons_for_elementor_get_link_attributes( $item['item_link'] ) ); ?>>
<?php endif; ?>
