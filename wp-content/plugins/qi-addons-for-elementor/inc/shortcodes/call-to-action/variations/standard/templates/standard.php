...
<div <?php qi_addons_for_elementor_framework_class_attribute( $holder_classes ); ?>>
	<div class="qodef-m-inner">
		...
		<?php if ( 'yes' === $enable_link_overlay && ! empty( $button_link['url'] ) ) { ?>
			<a class="qodef-m-link" href="<?php echo esc_url( $button_link['url'] ); ?>" <?php qi_addons_for_elementor_framework_inline_attrs( qi_addons_for_elementor_get_link_attributes( $button_link ) ); ?>></a>
		<?php } ?>
	</div>
</div>
