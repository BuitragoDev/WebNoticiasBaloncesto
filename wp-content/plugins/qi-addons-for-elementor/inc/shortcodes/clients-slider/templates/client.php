		...
		<div class="qodef-e-images-holder">
			<?php if ( ! empty( $client_main_image ) ) { ?>
				<div class="qodef-e-main-image">
					...
					echo qi_addons_for_elementor_get_list_shortcode_item_image( $images_proportion, $client_main_image, intval( $custom_image_width ), intval( $custom_image_height ) );
					?>
				</div>
			<?php } ?>
			<?php if ( ! empty( $client_hover_image ) ) { ?>
				<div class="qodef-e-hover-image">
					<?php
					// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo qi_addons_for_elementor_get_list_shortcode_item_image( $images_proportion, $client_hover_image, intval( $custom_image_width ), intval( $custom_image_height ) );
					?>
				</div>
			<?php } ?>
		</div>
