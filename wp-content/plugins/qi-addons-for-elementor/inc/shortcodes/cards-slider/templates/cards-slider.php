...
<div <?php qi_addons_for_elementor_framework_class_attribute( $holder_classes ); ?> <?php qi_addons_for_elementor_framework_inline_attrs( $data_attrs ); ?>>
			...
			<div class="qodef-m-card">
				<div class="qodef-m-bundle-item">
					<?php if ( '' !== $item['item_link']['url'] ) { ?>
						<a href="<?php echo esc_url( $item['item_link']['url'] ); ?>" <?php qi_addons_for_elementor_framework_inline_attrs( qi_addons_for_elementor_get_link_attributes( $item['item_link'] ) ); ?>>
					<?php } ?>
						<?php
						// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						echo qi_addons_for_elementor_get_list_shortcode_item_image( $images_proportion, $item['item_image'], intval( $custom_image_width ), intval( $custom_image_height ) );
						?>
					<?php if ( '' !== $item['item_link']['url'] ) { ?>
						</a>
					<?php } ?>
	...
	<div class="qodef-m-fake-card">
		<?php
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo qi_addons_for_elementor_get_list_shortcode_item_image( $images_proportion, $fake_card['item_image'], intval( $custom_image_width ), intval( $custom_image_height ) );
		?>
	</div>
